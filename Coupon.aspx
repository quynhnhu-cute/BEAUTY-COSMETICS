            ...
            <div class="table-wrapper">
                ...
                <asp:Panel ID="CartPanel" runat="server">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:CSharpAssignmentConnectionString %>"
                        ...
                        SelectCommand="SELECT [ID], [Code], [Value], [ImportDate], (SELECT Name FROM Status WHERE ID = [StatusID] ) AS StatusName, [StatusID], [ExpiredDate] FROM [Discount]"
                        UpdateCommand="UPDATE [Discount] SET [Code] = @Code, [Value] = @Value, [ImportDate] = @ImportDate, [StatusID] = @StatusID, [ExpiredDate] = @ExpiredDate WHERE [ID] = @ID" ProviderName="System.Data.SqlClient">
                        <DeleteParameters>
                    ...
                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:CSharpAssignmentConnectionString %>" SelectCommand="SELECT [ID], [Name] FROM [Status]"></asp:SqlDataSource>
                </asp:Panel>
            </div>
        </div>
    </asp:Panel>
