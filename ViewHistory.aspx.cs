...
namespace CSharpAssignment
{
    public partial class ViewHistory : System.Web.UI.Page
    {
        ...
        {
            CmdString = "Select Distinct P.Name, P.Price, BD.Amount, D.Code, D.Value, (BD.Amount * P.Price) as TotalPrice, ((BD.Amount * P.Price) *((100-D.Value) / 100)) as Pay From[dbo].[Booking] B, [dbo].[Discount] D, [dbo].[Product] P, [dbo].[BookingDetail] BD Where B.DiscountID = D.ID and BD.ProductID = P.ID and BD.BookingID = @BookingID";
            conn = new SqlConnection(ConString);
            cmd = new SqlCommand(CmdString, conn);
